...
mod tests {
    ...
    async fn test_get_state_response_normal() {
        ...
        let response: Result<claw_one::types::StateResponse, claw_one::error::AppError> =
            state_manager.get_state_response().await;
    ...
    async fn test_safe_mode_to_normal_recovery() {
        ...
        // 1. 进入 SafeMode
        state_manager
            .enter_safe_mode(ErrorType::Config, "Test error".to_string(), false, None)
            .await;
        ...
        // 这里只测试状态转换逻辑
        let result: std::result::Result<(), claw_one::error::AppError> =
    ...
    async fn test_apply_config_sets_applying_state() {
        ...
        let result = state_manager
            .apply_config(new_config, Some("Test config".to_string()))
            .await;
    ...
    async fn test_safe_mode_with_long_message() {
        ...
        state_manager
            .enter_safe_mode(ErrorType::System, long_message, false, None)
            .await;
    ...
    async fn test_concurrent_state_access() {
        ...
        let write_handle = tokio::spawn(async move {
            sm.enter_safe_mode(ErrorType::Config, "Test".to_string(), false, None)
                .await;
        });
